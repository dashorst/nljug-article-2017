...
Vier sprints later lijkt de applicatie totaal niet meer op de screenshots en mag je dus weer van voren af aan beginnen.
...
Met behulp van _Arquillian_, _WebDriver_ en _Graphene_ wordt in de tests een browser aangestuurd die de webapplicatie test.
